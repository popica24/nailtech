                  ...
                  <div className="flex flex-wrap w-full">
                    <div className="w-full">
                      <div className="bix-achievement relative flex w-full max-md:flex-col">
                        <div className="bix-achievement-inner bix-border-r w-[50%] pr-[30px] md:border-r-[0.5px] border-solid border-[#111a24] max-md:w-full max-md:flex max-md:flex-col max-md:border-[0] max-md:p-[0]">
                          <div
                          ...
                          >
                            <div className="achievement-year w-[100px] h-full absolute top-[0] flex items-center justify-center rotate-[270deg] z-10 right-[-82px] max-md:block max-md:rotate-0 max-md:top-[-13px] max-md:left-[45px]">
                              <span className="bg-[#111a24] text-[#fff] border-[1px] border-solid border-[#111a24] rounded-[10px] leading-[1] py-[3px] px-[10px] montserrat-300 font-normal tracking-[0.02rem] text-[14px]"></span>
                            </div>
                            ...
                            <p className="overflow-hidden text-ellipsis flex m-[0] montserrat-300 text-[14px] text-[#495461] font-normal leading-[26px] tracking-[0.03rem]">
                              Aneta a reunit o echipă unică de traineri, o grupă
                              restrânsă, aleasă cu grijă, din care am avut
                              onoarea și bucuria să fac parte. A fost o
                              experiență deosebită să învăț și să colaborez
                              alături de oameni pasionați, dedicați și
                              inspirați, într-un cadru profesional construit cu
                              atenție și respect pentru fiecare participant.
                            </p>
                          </div>
                          <div
                          ...
                          >
                            ...
                            <h4 className="mb-[8px] montserrat-300 text-[18px] font-semibold leading-[26px] text-[#111a24] tracking-[0.03rem] max-md:text-[16px] max-md:leading-[25px]">
                              Propriul brand de ustensile
                            </h4>
                            <p className="overflow-hidden text-ellipsis flex m-[0] montserrat-300 text-[14px] text-[#495461] font-normal leading-[26px] tracking-[0.03rem]">
                              Timp de 2 ani am lucrat la lansarea propriului
                              brand de ustensile, testate și ajustate până la
                              cel mai înalt standard. Mi-am dorit produse exact
                              așa cum îmi place mie să lucrez: precise, de
                              încredere, durabile.
                            </p>
                          </div>
                        </div>
                        <div className="bix-achievement-inner bix-border-l w-[50%] pl-[30px] md:border-l-[0.5px] border-solid border-[#111a24] max-md:w-full max-md:flex max-md:flex-col max-md:border-[0] max-md:p-[0] max-md:mb-[-24px]">
                          <div
                          ...
                          >
                            ...
                            <p className="overflow-hidden text-ellipsis flex m-[0] montserrat-300 text-[14px] text-[#495461] font-normal leading-[26px] tracking-[0.03rem]">
                              Accesul la cursurile ei se face exclusiv pe baza
                              unui examen riguros, atât teoretic, cât și
                              practic, ceea ce asigură un mediu de învățare
                              format din cursanți dedicați și bine pregătiți.
                            </p>
                          </div>
                          <div
                          ...
                          >
                            <div className="achievement-year w-[100px] h-full absolute top-0 flex items-center justify-center rotate-[270deg] z-10 -left-[82px] max-md:block max-md:rotate-0 max-md:top-[-13px] max-md:left-[45px]">
                              <span className="bg-[#111a24] text-white border border-solid border-[#111a24] rounded-[10px] leading-[1] py-[3px] px-[10px] montserrat-300 font-normal tracking-[0.02rem] text-[14px]"></span>
                            </div>
                            <h4 className="mb-[8px] montserrat-300 text-[18px] font-semibold leading-[26px] text-[#111a24] tracking-[0.03rem] max-md:text-[16px] max-md:leading-[25px]">
                              140+ Cliente intr-o singura luna{" "}
                            </h4>
                            <p className="overflow-hidden text-ellipsis flex m-[0] montserrat-300 text-[14px] text-[#495461] font-normal leading-[26px] tracking-[0.03rem]">
