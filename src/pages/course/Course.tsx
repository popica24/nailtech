...
const Course = () => {
  return (
    <>
      <div className="mt-30 relative w-full h-[320px]" id="home">
        ...
        <div className="absolute inset-9 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-4 md:mb-0">
            ...
            <p className="font-regular text-xl mb-8 mt-4 montserrat-400">
              Curs de baza specializare pentru unghii cu gel
            </p>
            <a
              href="/"
              className="px-6 py-3 bg-[#c8a876] text-white font-medium rounded-full hover:bg-[#c09858]  transition duration-200 montserrat-300"
            >
              Cumpara un loc
            </a>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-gray-700 text-base">
                  ...
                  aliquid a omnis neque illum amet facilis dolorum nesciunt
                  vero. Dignissimos nesciunt non, temporibus magni quia
                  perferendis quis molestiae numquam. Minus.
                </p>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6 text-center">
                <h3 className="text-xl font-medium text-gray-800 mb-2">
                  Rezistenta Manichiurii
                </h3>
                <p className="text-gray-700 text-base">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Repellat ipsum optio, non at, mollitia eligendi ea cum,
                  ducimus ad praesentium harum? Repudiandae, omnis. Inventore
                  praesentium modi cumque accusantium quibusdam rerum!
                </p>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-gray-700 text-base">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Explicabo ex commodi alias cumque voluptates aperiam hic
                  laboriosam, itaque at vero labore ratione eligendi, ipsa,
                  porro aliquid dicta? Odio, doloribus sint.
                </p>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6 text-center">
                <h3 className="text-xl font-medium text-gray-800 mb-2">
                  Stilizarea Cuticulei
                </h3>
                <p className="text-gray-700 text-base">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Labore, eligendi exercitationem? Minima, accusamus a aliquam
                  dolorum labore expedita ducimus quisquam error placeat sunt
                  voluptate repudiandae laboriosam minus ab et vitae?
                </p>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6 bg-white text-center rounded-b-lg md:min-h-full">
                ...
                <p className="text-gray-700 text-base">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Libero architecto quia aspernatur quaerat accusamus quo
                  aliquam ducimus cupiditate, ea optio fugit illum maxime
                  obcaecati voluptatum dignissimos corporis eveniet pariatur
                  quos.
                </p>
              </div>
            </div>
          ...
          <div className="mt-8 lg:mt-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="max-w-full mx-auto rounded-lg overflow-hidden">
                  <div className="border-t border-gray-200 px-6 py-4">
                    ...
                    <p className="mt-1 text-gray-600">
                      <a href="tel:+123">Telefon: +91 123456789</a>
                    </p>
                  ...
                  <div className="px-6 py-4 montserrat-300">
                    <h3 className="text-lg font-medium text-gray-900">
                      Strada unghiilor nr. 6
                    </h3>
                    <p className="mt-1 text-gray-600">Aici scrii adresa</p>
                  </div>
                  <div className="border-t border-gray-200 px-6 py-4 montserrat-300">
                    <h3 className="text-lg font-medium text-gray-900">Ore</h3>
                    <p className="mt-1 text-gray-600">
                      Luni - Sambata : 2pm - 9pm
                    </p>
                  </div>
                </div>
              </div>
              <div className="rounded-lg overflow-hidden order-none sm:order-first">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d22345.378764364214!2d25.320209103222243!3d45.566972698824245!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40b348dcdc7568db%3A0x7ee9bb8e7963ab49!2zWsSDcm5lyJl0aQ!5e0!3m2!1sen!2sro!4v1744968863287!5m2!1sen!2sro"
                  width="600"
                  height="450"
                  style={{ border: "0" }}
                  allowFullScreen
