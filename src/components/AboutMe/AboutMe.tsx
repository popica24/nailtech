          ...
          >
            <div className="bix-about-contact h-full flex flex-col justify-center">
              ...
              <p className="mb-[16px] montserrat-400 text-[14px] text-[#495461] font-normal leading-[26px] tracking-[0.03rem]">
                ...
                pasiune și creativitate, transform fiecare detaliu într-o operă
                de artă, aducând frumusețe și eleganță prin tehnici inovatoare
                și un design unic.{" "}
              </p>
              ...
              <div className="bix-rounded-circle z-[1] h-[130px] w-[130px] absolute bottom-[0] right-[0] bg-[var(--nude-cald)] rounded-[50%] max-[575px]:h-[120px] max-[575px]:w-[120px] max-[575px]:bottom-[20px] max-[575px]:right-[20px] max-md:bottom-[0] max-md:right-[0]">
                <a className="relative">
                  ...
                  <div className="inner-contact w-full h-full absolute top-[0] left-[0] right-[0] flex justify-center items-center">
                    <i className="fa-solid fa-arrow-up-right-from-square text-[30px] text-[#2c2c2c]"></i>
                  </div>
                </a>
              </div>
          ...
          <div className="max-[1199px]:order-3 min-[1200px]:w-[33.33%] min-[992px]:w-[50%] w-full px-[12px]">
            ...
            >
              <div
                ...
                data-aos-delay="600"
              >
                <div className="skill-logo transition-all duration-[0.3s] ease-in-out flex justify-end absolute right-[60px] top-[-30px] z-[1] opacity-[0]">
                  <a
                    href="javascript:void(0)"
                    className="relative h-[30px] w-[30px] mx-[20px] border-[1px] border-solid border-[#111a24] bg-[#fff] rounded-[20px]"
                  >
                ...
                <div className="skill-contact inline-flex flex-wrap max-md:flex-col">
                  <svg
              ...
              <div
                ...
                data-aos-delay="1000"
              >
                <div className="skill-logo transition-all duration-[0.3s] ease-in-out flex justify-center absolute right-[60px] top-[-30px] z-[1] opacity-[0]">
                  <a
                    href="javascript:void(0)"
                    className="relative h-[30px] w-[30px] mx-[20px] border-[1px] border-solid border-[#111a24] bg-[#fff] rounded-[20px]"
                  >
